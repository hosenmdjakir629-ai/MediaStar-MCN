    ...
    if (isLoadingData) {
      return (
        <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
          ...
          <p className="text-gray-400 font-medium animate-pulse">Syncing with OrbitX MCN Database...</p>
        </div>
      );
    }
        ...
        <main className={`flex-1 transition-all duration-500 ${isSidebarOpen ? 'lg:ml-64' : 'ml-0'} relative z-10 overflow-auto custom-scrollbar`}>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-3 pl-6 border-l border-white/10">
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-[10px] text-surface-500 font-bold uppercase tracking-widest">OrbitX MCN HQ</p>
                </div>
          ...
          <div className="p-4 sm:p-8">
            <Routes>
              ...
              <Route path="/payment" element={
                <Suspense fallback={<div className="flex items-center justify-center h-[60vh]"><div className="w-10 h-10 border-4 border-orbit-500 border-t-transparent rounded-full animate-spin"></div></div>}>
                  <PaymentPage />
                </Suspense>
              } />
              <Route path="/success" element={
